...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> uraniumTargets = List.of(
                OreFeatureConfig.createTarget(stoneOreReplaceables, ModBlocks.URANIUM_ORE.getDefaultState()),
                OreFeatureConfig.createTarget(deepslateOreReplaceables, ModBlocks.DEEPSLATE_URANIUM_ORE.getDefaultState()));
        ...
        register(context, URANIUM_ORE_KEY, Feature.ORE, new OreFeatureConfig(uraniumTargets, 5));
