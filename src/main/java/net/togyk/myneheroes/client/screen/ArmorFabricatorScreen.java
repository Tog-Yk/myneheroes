...
public class ArmorFabricatorScreen extends HandledScreen<ArmorFabricatorScreenHandler> {
    ...
    public ArmorFabricatorScreen(ArmorFabricatorScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawMouseoverTooltip(DrawContext context, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<RecipeEntry<ArmorFabricatingRecipe>> list = this.handler.getAvailableRecipes();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (this.canCraft) {
            ...
            for(int l = this.scrollOffset; l < k; ++l) {
                ...
                if (d >= (double)0.0F && e >= (double)0.0F && d < (double)16.0F && e < (double)18.0F && this.handler.onButtonClick(this.client.player, l)) {
