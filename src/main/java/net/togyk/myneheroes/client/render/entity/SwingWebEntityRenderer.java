...
public class SwingWebEntityRenderer extends ProjectileEntityRenderer<WebSwingEntity> {
    public SwingWebEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    @Override
    public Identifier getTexture(WebSwingEntity entity) {
        return Identifier.of(MyneHeroes.MOD_ID, "textures/entity/projectiles/web.png");
    }

    @Override
    public void render(WebSwingEntity entity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        matrixStack.push();
        float size = 0.5f;
