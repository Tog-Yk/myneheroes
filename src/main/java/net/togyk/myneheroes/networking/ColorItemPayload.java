...
public record ColorItemPayload(BlockPos pos, int index, int color, boolean setDefault) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ColorItemPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.BOOL, ColorItemPayload::setDefault,
