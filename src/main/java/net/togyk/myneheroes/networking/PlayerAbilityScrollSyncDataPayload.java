...
public record PlayerAbilityScrollSyncDataPayload(int scrolled) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, PlayerAbilityScrollSyncDataPayload> CODEC = PacketCodec.tuple(
            PacketCodecs.INTEGER, PlayerAbilityScrollSyncDataPayload::scrolled,
