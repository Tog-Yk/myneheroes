...
public class Powers {
    ...
    public static SpeedsterPower SPEEDSTER = registerPower(new SpeedsterPower(Identifier.of(MyneHeroes.MOD_ID, "speedster"), 0xFFFFDE3A, List.of(Abilities.TOGGLE_OR_CONFIGURE_SPEED, Abilities.TOGGLE_PHASING), 15,
