...
public class Powers {
    ...
    public static KryptonianPower KRYPTONIAN = registerPower(new KryptonianPower(Identifier.of(MyneHeroes.MOD_ID, "kryptonian"), 10000, 0xFF9CDB94, List.of(Abilities.FROST_BREATH.copy(), Abilities.LASER_EYES.copy()),
    ...
    public static SpeedsterPower SPEEDSTER = registerPower(new SpeedsterPower(Identifier.of(MyneHeroes.MOD_ID, "speedster"), 0xFFFFDE3A, List.of(Abilities.TOGGLE_SPEED.copy(), Abilities.SPEED_UP.copy(), Abilities.SPEED_DOWN.copy(), Abilities.TOGGLE_PHASING.copy()), 15,
