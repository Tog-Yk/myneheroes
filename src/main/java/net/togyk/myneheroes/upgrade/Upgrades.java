...
public class Upgrades {
    ...
    public static final Upgrade HUD = registerUpgrade(new AbilityUpgrade(Abilities.TOGGLE_HUD, List.of(ArmorItem.Type.HELMET), Identifier.of(MyneHeroes.MOD_ID, "hud")));
