...
public class KryptoniteClusterBlock extends KryptoniteRadiationBlock implements Waterloggable {
    public static final MapCodec<KryptoniteClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    .apply(instance, KryptoniteClusterBlock::new)
    );
    ...
    @Override
    public MapCodec<KryptoniteClusterBlock> getCodec() {
        return CODEC;
    }

    public KryptoniteClusterBlock(float height, float width, AbstractBlock.Settings settings) {
        super(settings);
