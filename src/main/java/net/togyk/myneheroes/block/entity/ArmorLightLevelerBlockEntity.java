...
public class ArmorLightLevelerBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPosPayload> {
    ...
    public ArmorLightLevelerBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntityTypes.ARMOR_LIGHT_LEVELER_BLOCK_ENTITY, pos, state);
    }
    ...
    public @Nullable ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new ArmorLightLevelerScreenHandler(syncId, playerInventory, this);
    }
